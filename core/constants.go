...
var (
	...
	PromptMsg = map[string]map[string]interface{}{
		...
		"server_cutback_task_running_error": gin.H{"msg": "所减少的服务器有正在运行的爬虫或者定时任务，请先删除或者停止"},
		"server_del_task_running_error":     gin.H{"msg": "此服务器有正在运行的爬虫或者定时任务，请先删除或者停止"},
		//项目相关
		...
		"project_del_error":                 gin.H{"msg": "项目删除失败，请重试(某些服务器上的项目文件可能已经删除)"},
		"project_task_running_error":        gin.H{"msg": "当前项目有正在运行的爬虫或者定时任务，请先删除或者停止"},
